...
write.csv(txtDataFinal2,file="txtDataFinalT")
```
...
###在ptt八卦版上 標題有提及關於反送中關鍵字的折線圖

```{r titleCompleteLineChart}
#title 
...
Graph_plus_title<-Graph_title+scale_color_manual(values=c("#28004d","#ea0000", "#00db00","#ff8000","#613030","#ffa042","#5b5b5b","#eac100"))+ scale_x_date(date_minor_breaks = "3 day")+scale_y_continuous(trans = 'sqrt') 
print(Graph_plus_title)
```

###在ptt八卦版上 內文有提及關於反送中關鍵字的折線圖

```{r excerptCompleteLineChart}
#txt
...
Graph_plus_title_S<-Graph_title_S+scale_color_manual(values=c("#28004d","#ea0000", "#00db00","#ff8000","#613030"))+ scale_x_date(date_minor_breaks = "3 day")+scale_y_continuous(trans = 'sqrt') 
...
Graph_plus_txt_S<-Graph_txt_S+scale_color_manual(values=c("#28004d","#ea0000", "#00db00","#ff8000","#613030"))+ scale_x_date(date_minor_breaks="3 day ")+scale_y_continuous(trans = 'sqrt') 
